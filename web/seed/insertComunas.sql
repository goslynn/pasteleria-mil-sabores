...
VALUES
    ...
    ('Región del Libertador General Bernardo OHiggins',1),
    ('Región del Maule',1),
    ('Región de Ñuble',1),
    ('Región del Biobío',1),
    ...
    ('Región Aysén del General Carlos Ibáñez del Campo',1),
    ('Región de Magallanes y de la Antártica Chilena',1);

INSERT INTO COMUNA (nombre, idRegionFk)
VALUES
    ('Arica',1),
    ('Camarones',1),
    ('Putre',1),
...
VALUES
    ('Invitado', 'Invitado@local', '', '2000-01-01', '2000-01-01 00:00:00');
